 ...
 * @returns 收缩后对象
 */
export function flatten(target: any, opts?: FlattenProps) {
    opts = opts || {}
 ...
 * @returns 展开结果
 */
export function unflatten(target: any, opts?: FlattenProps) {
    opts = opts || {}
    ...
    target = Object.keys(target).reduce(function (result: any, key: string) {
